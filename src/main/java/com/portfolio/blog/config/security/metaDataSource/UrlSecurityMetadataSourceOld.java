...
@Slf4j
public class UrlSecurityMetadataSourceOld implements FilterInvocationSecurityMetadataSource {

    private LinkedHashMap<RequestMatcher, List<ConfigAttribute>> requestMap;
    private ResourceService resourceService;

    public UrlSecurityMetadataSourceOld(LinkedHashMap<RequestMatcher, List<ConfigAttribute>> requestMap, ResourceService resourceService) {
