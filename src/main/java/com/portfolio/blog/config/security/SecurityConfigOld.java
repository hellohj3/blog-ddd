...
import com.portfolio.blog.config.security.metaDataSource.UrlSecurityMetadataSourceOld;
...
public class SecurityConfigOld extends WebSecurityConfigurerAdapter {
    ...
    public FilterInvocationSecurityMetadataSource urlSecurityMetadataSource(ResourceService resourceService) {
        return new UrlSecurityMetadataSourceOld(urlResourcesMapFactoryBean(resourceService).getObject(),resourceService);
    }
